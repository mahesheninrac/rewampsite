...
<div class="accordion-container">
    ...
    <div class="accordion-item">
        <button class="accordion-header" onclick="toggleAccordion(this)">
            <span class="accordion-title">What documentation is required for corporate bookings?</span>
            <div class="chevron"></div>
        </button>
        <div class="accordion-content">
            <div class="accordion-text">
                Corporate bookings usually require your company's corporate travel account number, employee
                authorization, valid identification, and sometimes additional documentation depending on the
                airline's
                policy. Some airlines may also require pre-approval for certain types of bookings or
                destinations.
            </div>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <button class="accordion-header" onclick="toggleAccordion(this)">
            <span class="accordion-title">How can I track corporate travel expenses?</span>
            <div class="chevron"></div>
        </button>
        <div class="accordion-content">
            <div class="accordion-text">
                Most corporate travel programs provide detailed monthly reports, online dashboards for
                real-time
                tracking, integration with expense management systems, and customizable reporting options.
                This
                allows
                you to monitor spending patterns, identify cost-saving opportunities, and ensure compliance
                with
                travel
                policies.
            </div>
