                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="border-radius-40">
                            <img src="<?= base_url(); ?>assets/images/services/business-intelligence.png"
    ...
    <div class="container">
        <div class="py-5">
            <div class="row row-gap-3">
                <div class="col-md-7">
                    <div class="bg-primary service-top-item h-100">
                        <p class="service-top-item--title text-white">
                            Forget about long search and endless emails
                            <br>
                            Book in a few clicks thanks to a familiar interface
                        </p>
                        <div class="service-top-item--img">
                            <img src="<?= base_url(); ?>assets/images/service-block-1.png" alt="Service images">
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="service-top-item light-grey-bg">
                        <p class="service-top-item-title">
                            <strong> Save on a budget</strong> <br>
                ...
                <div class="col-md-5">
                    <div class="service-top-item light-grey-bg">
                        <h2 class="fw-600">Service Engagement Model</h2>
                        <div class="service-top-item--img">
                            <picture>
                                <img src="https://tumodo.io/storage/uploads/1136c465c608a95acece03e2f83ac0ea.png"
                                    alt="">
                            </picture>
                        </div>
                    </div>
                ...
                <div class="col-md-7">
                    <div class="service-top-item static-animation" style="background-color: #635bff;" data-msg-reveal>
                        ...
                        <div class="service-tile _light-grey-bg static-animation" data-msg-reveal data-delay="500">
                            <div class="text-start">
                                ...
                                <p>Tumodo’s user-friendly interface helps navigate all travel-related processes easily,
                                    making organising business travel simple and efficient.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="service-tile _light-grey-bg static-animation" data-msg-reveal data-delay="500">
                            <div class="text-end">
                                ...
                                <p>Track employee flights directly in your personal account. Receive instant
                                    notifications about flight cancellations or delays in the most convenient way.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-tile _light-grey-bg static-animation" data-msg-reveal data-delay="500">
                            <div class="text-start">
                                ...
                                <p>Travel policies and approval schemes help to save up to 35% of the company’s budget.
                                    Give employees access to bookings without the risk of overpayments.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="service-tile _light-grey-bg static-animation" data-msg-reveal data-delay="500">
                            <div class="text-start">
                                ...
                                <p>Everything you are used to and even more, in one platform. Advanced functionality,
                                    flexible filters and selection of flights according to your preferences.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row row-gap-4">
                    <div class="col-md-6">
                        <div class="available-tile _light-grey-bg">
                            <div class="available-tile--img static-animation" style="height: 165px;" data-msg-reveal>
                                <img src="<?= base_url(); ?>assets/images/services/featured/advisory-services.png"
                                    class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="available-tile _light-blue2-bg">
                            <div class="available-tile--img static-animation" style="height: 165px;" data-msg-reveal>
                                <img src="<?= base_url(); ?>assets/images/services/featured/due-diligence.png"
                                    class="img-fluid" alt="">
                            </div>
